Shader "Eric/Builtin_AdditiveFlow_HDR"
{
    Properties
    {
        [CanUseSpriteAtlas]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _Brightness, _FresnelPower, _SoftParticlesDistance, _DissolveAmount, _VertexAlphaRef, _DissolveEdgeWidth;
