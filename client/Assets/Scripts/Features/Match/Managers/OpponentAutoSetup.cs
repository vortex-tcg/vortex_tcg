...
namespace VortexTCG.Scripts.MatchScene
{
    ...
    public class OpponentAutoSetup : MonoBehaviour
    {
        ...
        [Header("Run Control")] [SerializeField]
...
// 
        ...
        private void ApplyRandomData(Card card, int seedOffset)
        {
            ...
            {
                case 0:
                    card.ApplyDTO(System.Guid.NewGuid().ToString(), "P2 Guerrier", 10, 5, 3, "Guerrier adverse",
                        ""); break;
                case 1: card.ApplyDTO(System.Guid.NewGuid().ToString(), "P2 Mage", 6, 8, 4, "Mage adverse", ""); break;
                case 2:
                    card.ApplyDTO(System.Guid.NewGuid().ToString(), "P2 Soigneur", 5, 2, 2, "Soigneur adverse",
                        ""); break;
                default:
                    card.ApplyDTO(System.Guid.NewGuid().ToString(), "P2 Archer", 7, 6, 3, "Archer adverse", ""); break;
            }
        }
